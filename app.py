...
def api_complaints():
    if request.method == 'POST':
        ...
        priority = 'Medium'
        if category in ['Streetlights Not Working', 'Play Area Issues', 'Waterlogging']:
            priority = 'High'
        elif category in ['Damaged Benches', 'Broken Gym Equipment', 'Garbage Accumulation']:
            priority = 'Medium'
        else:
            priority = 'Low'
